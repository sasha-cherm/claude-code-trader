#!/usr/bin/env python3
"""
Near-resolution PM monitor for March 22, 2026 (Saturday).
Continuation of near_res_mar22.py which expires at ~15:23 UTC.
Covers all games from 12:00 UTC through 03:00 UTC March 23.
Added: Portland-Denver (NBA), Washington-NYK (NBA), Norwegian Eliteserien.
HUGE DAY: EPL (3), EFL Cup Final, Bundesliga (3), La Liga (4), Serie A (4),
Eredivisie (3), Ligue 1 (3), Portuguese (1), NBA (5), MLS (5),
...
ALL_GAMES = [
    ...
    # === ADDITIONAL NBA (not in original monitor) ===
    # Trail Blazers vs Nuggets — 21:00 UTC kick (end ~23:00 UTC)
    {"name": "Trail Blazers", "token_id": "76411485007905403260867254591514865884721695065913236805290522714118524591717",
     "end_date": "2026-03-22T23:00:00Z", "pre_game_price": 0.0,
     "question": "Trail Blazers vs. Nuggets"},
    {"name": "Nuggets", "token_id": "56185343724788691653371860856932764492283446158059363583698627335446990817465",
     "end_date": "2026-03-22T23:00:00Z", "pre_game_price": 0.0,
     "question": "Trail Blazers vs. Nuggets"},

    # Wizards vs Knicks — 23:30 UTC kick (end ~01:30 UTC Mar 23)
    {"name": "Wizards", "token_id": "107624296118804314041821833456325748560953651543617361500856815536352812487276",
     "end_date": "2026-03-23T01:30:00Z", "pre_game_price": 0.0,
     "question": "Wizards vs. Knicks"},
    {"name": "Knicks", "token_id": "78766565665006011843192774302897731367783297972818011538107321774452309351547",
     "end_date": "2026-03-23T01:30:00Z", "pre_game_price": 0.0,
     "question": "Wizards vs. Knicks"},

    # === NORWEGIAN ELITESERIEN ===
    # Rosenborg vs Vålerenga — 13:30 UTC kick
    {"name": "Rosenborg", "token_id": "6143243689462395783315625395435348239870819203014154950996943767902116937346",
     "end_date": "2026-03-22T15:15:00Z", "pre_game_price": 0.0,
     "question": "Will Rosenborg BK win on 2026-03-22?"},
    {"name": "Valerenga", "token_id": "74039182062898641583402760208620090376093604770347548982840003945631474531120",
     "end_date": "2026-03-22T15:15:00Z", "pre_game_price": 0.0,
     "question": "Will Rosenborg BK win on 2026-03-22?"},

    # Brann vs Tromsø — 16:00 UTC kick
    {"name": "Brann", "token_id": "24257519475765476947422542456129679722444314875554218826254303302875112626576",
     "end_date": "2026-03-22T17:45:00Z", "pre_game_price": 0.0,
     "question": "Will SK Brann win on 2026-03-22?"},
    {"name": "Tromso", "token_id": "39147685252596069414924309105945797200863237124840032169852363609513598005965",
     "end_date": "2026-03-22T17:45:00Z", "pre_game_price": 0.0,
     "question": "Will SK Brann win on 2026-03-22?"},

    # Bodø/Glimt vs Hamarkameratene — 18:15 UTC kick
    {"name": "Bodo/Glimt", "token_id": "60948099391773904478023123632495075766808527029619236144566281176927006525251",
     "end_date": "2026-03-22T20:00:00Z", "pre_game_price": 0.0,
     "question": "Will FK Bodø/Glimt win on 2026-03-22?"},
    {"name": "Hamarkameratene", "token_id": "101873243975902511492926999529399733568663381717310003393993442224072762161069",
     "end_date": "2026-03-22T20:00:00Z", "pre_game_price": 0.0,
     "question": "Will FK Bodø/Glimt win on 2026-03-22?"},
]
...
if __name__ == "__main__":
    ...
    for i in range(1080):  # 18 hours (covers 09:00 UTC through 03:00 UTC Mar 23)
